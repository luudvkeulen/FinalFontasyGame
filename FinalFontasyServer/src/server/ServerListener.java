...
public class ServerListener implements Runnable {
    ...
    private void receiveObject(DatagramPacket packet, Object data) {
        ...
        if (data instanceof SimplePlayer) {
            ...
            return;
        } else if (data instanceof VoiceSound) {
            System.out.println("Received Voice Chat from " + packet.getSocketAddress().toString());
            server.receiveVoiceSound(validSender, (VoiceSound) data);
            return;
        } else {
