...
/**
 * This class represents a text message.
 * It contains the name of the playername,
 * the content of the message, and the date
 * of the message.
 * 
 * This class is made to save the data only, it does 
...
public class ChatTextMessage {
    /**
     * The name of the player who made the message.
     ...
     * This gets initialized with the right value.
     */
    private Date date;
    
    /**
     * The constructor of the class ChatTextMessage.
     * The constructor gives all the variables in this class
     * a value.
     * 
     ...
     * It returns the message like how it should
     * appear in the chatbox.
