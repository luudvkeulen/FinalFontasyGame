...
public class Player extends SimplePlayer {
    ...
    /**
     * Make a player from a SimplePlayer intance and GameScreen instance.
     * @param simplePlayer The SimplePlayer object which we use to 
     * initialize this player, may not be null.
     * @param screen The screen which we use to initialize the player, 
     * mot not be null.
     */
    public Player(SimplePlayer simplePlayer, GameScreen screen) {
        ...
        if (simplePlayer == null) {
            throw new IllegalArgumentException("SimplePlayer may not be null");
        }
        
        if (screen == null) {
            throw new IllegalArgumentException("GameScreen may not be null");
        }
    ...
    private void switchCharacter(PlayerCharacter character) {
        ...
        if (character == null) {
            throw new IllegalArgumentException("PlayerCharacter may not be null");
        }
     ...
     * 
     * @throws IllegalArgumentException when SpriteBatch is null.
     */
    public void render(SpriteBatch batch) {
        
        if (batch == null) {
            throw new IllegalArgumentException("SpriteBatch may not be null");
        }
    ...
    private boolean checkCollision(Rectangle rec, MapObjects objects, MapObjects wallobjects) {
        ...
        if (rec == null) {
            throw new IllegalArgumentException("Rectangle may not be null");
        }
        
        if (objects == null) {
            throw new IllegalArgumentException("MapObjects may not be null");
        }
        
        if (wallobjects == null) {
            throw new IllegalArgumentException("WallObjects may not be null");
        }
     ...
     * 
     * @throws IllegalArgumentException when Direction is null.
     */
    public void setDirection(Direction direction) {
        
        if (direction == null) {
            throw new IllegalArgumentException("Direction is not null");
        }
     ...
     * assets.
     * 
     * @throws IllegalArgumentException when walkingAnimation is null or empty.
     */
    private void setWalkingAnimations(String walkingAnimation) {
        
        if (walkingAnimation == null || walkingAnimation.trim().isEmpty()) {
            throw new IllegalArgumentException("WalkingAnimation may not be null or empty.");
        }
        ...
        TextureRegion[][] anims = TextureRegion.split(walkSheet, 
                walkSheet.getWidth() / walkSheet_Cols, 
                walkSheet.getHeight() / walkSheet_Rows);
     ...
     * assets.
     * 
     * @throws IllegalArgumentException when slashingAnimation is null or empty.
     */
    private void setSlashingAnimations(String slashingAnimation) {
        
        if (slashingAnimation == null || slashingAnimation.trim().isEmpty()) {
            throw new IllegalArgumentException("slashingAnimation may not be null or empty");
        }
        ...
        TextureRegion[][] anims = TextureRegion.split(slashSheet, 
                slashSheet.getWidth() / slashSheet_Cols, 
                slashSheet.getHeight() / slashSheet_Rows);
